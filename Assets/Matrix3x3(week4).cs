...
public class Matrix3x3Week4
{
    private const int matrixOrder = 3;

    // Static Variables
    // The identiy matrix
    public static Matrix3x3Week4 Identity
    {
        get
        {
            return new Matrix3x3Week4(
    ...
    // The zero matrix
    public static Matrix3x3Week4 Zero
    {
        get
        {
            return new Matrix3x3Week4(
    ...
    public Matrix3x3Week4 Inverse
    {
        get
        {
            return (1 / Determinant) * (new Matrix3x3Week4(
                new Vector3(
    ...
    public Matrix3x3Week4 Transpose
    {
        get
        {
            Matrix3x3Week4 transpose = new Matrix3x3Week4();
    ...
    private Matrix3x3Week4(Vector3 r1, Vector3 r2, Vector3 r3)
    {
        m[0] = r1;
        m[1] = r2;
        m[2] = r3;
    ...
    public static Matrix3x3Week4 operator *(Matrix3x3Week4 b, Matrix3x3Week4 c)
    {
        Matrix3x3Week4 resultMatrix = new Matrix3x3Week4();
        for (int i = 0; i < matrixOrder; i++)
        {
    ...
    public static Matrix3x3Week4 operator *(float b, Matrix3x3Week4 c)
    {
        Matrix3x3Week4 resultMatrix = new Matrix3x3Week4();
        for (int i = 0; i < matrixOrder; i++)
        {
    ...
    public static Matrix3x3Week4 operator *(Matrix3x3Week4 c, float b)
    {
        return b * c;
    }

    // Test the equality of this matrix and another
    public bool Equals(Matrix3x3Week4 m2)
    {
        for (int i = 0; i < matrixOrder; i++)
        {
            for (int j = 0; j < matrixOrder; j++)
